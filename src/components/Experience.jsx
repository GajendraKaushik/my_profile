    ...
    const experiences = [
        {
            ...
            type: "Full-time",
            skills: ["Python", "Typescript", "CI/CD", "AWS", "PostgreSQL", "Terraform", "AI"],
            current: true,
        },
        {
        ...
        <section className="py-8 md:py-16 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 max-w-6xl relative">
                ...
                <div className='relative flex flex-col md:flex-row md:items-start'>
                    {/* Timeline line */}
                    <div className='absolute left-6 md:left-1/2 top-0 h-full w-px bg-gradient-to-b from-purple-500/70 via-purple-400/50 to-transparent z-0' />
                    <div className="w-full">
                        {experiences.map((exp, index) => (
                            ...
                            >
                                ...
                                {/* Card */}
                                <div
                                    className={`ml-20 md:ml-0 md:w-[calc(50%-60px)] ${index % 2 === 0 ? "md:mr-auto" : "md:ml-auto"
                                        }`}
                                >
                                    <div className='relative group'>
                                        <div className="hidden md:block absolute top-8 w-8 h-px bg-gradient-to-r from-purple-500/70 to-transparent" />
                                        <div className='backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 bg-white/[0.07] border border-purple-500/30 hover:bg-white/[0.12] transition-all duration-500 shadow-lg'>
                                            {
                                                exp.current && (
